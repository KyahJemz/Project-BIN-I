		...
		<div className="bg-gray-100 min-h-screen">
			...
			<section className="bg-green-500 text-white py-20 text-center">
				...
				<p className="text-lg mb-6">
					Stay informed, participate, and make a difference in our
					community.
				</p>
				<div>
					<button className="bg-white text-green-700 px-6 py-2 rounded mr-4">
						Read News
					</button>
			...
			<footer className="bg-green-700 text-white py-4">
				<div className="container mx-auto text-center">
					<p>
						© 2024 BIN-I: INFORMATIVE WASTE MANAGEMENT PORTAL FOR
						CAVITE CITY. All Rights Reserved.
					</p>
				</div>
			</footer>
		</div>
