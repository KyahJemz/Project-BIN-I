...
const NewRoute = () => {
	...
	return (
		<main>
			<div className="max-w-4xl mx-auto p-6 bg-gray-50 rounded-lg shadow-mdc mb-6">
				{isGettingAllSchedules && !getAllSchedulesResponse ? (
					...
					<>
						...
						<div className="mb-6">
							...
							<div className="bg-gray-200 p-4 rounded-md shadow-sm h-96 flex flex-col justify-end">
						...
						<div className="text-right">
							<button
								...
								className={`w-full md:w-auto px-4 py-2 rounded-md text-white transition ${isCreatingRoute ? 'bg-gray-400' : 'bg-blue-600 hover:bg-blue-700'
									} focus:outline-none`}
							>
